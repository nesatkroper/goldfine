                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    @if ( count($seller_spread_packages_payments)==0 && $product->seller_spread_package_payment)
                                        @if($product->seller_spread_package_payment &&  $product->seller_spread_package_payment->expire_at > time())
