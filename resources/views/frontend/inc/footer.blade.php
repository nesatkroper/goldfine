        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="text-center text-md-left mt-4">
                        ...
                        <a href="/pdf.html" class="btn btn-primary btn-sm shadow-md" style="background-color: #2846b7;border-color: #2846b7;">
                            เกี่ยวกับฉัน
                        </a>
                    </div>
                <div class="mt-4">
        ...
        @if (Auth::check())
            ...
            @else
                <!--<a href="javascript:void(0)" class="text-reset d-block text-center pb-2 pt-3 mobile-side-nav-thumb" data-toggle="class-toggle" data-backdrop="static" data-target=".aiz-mobile-side-nav">-->
                 <a href="{{ route('seller.dashboard') }}" class="text-reset d-block text-center pb-2 pt-3 mobile-side-nav-thumb" >
                    <span class="d-block mx-auto">
                        @if(Auth::user()->photo != null)
                            <img src="{{ custom_asset(Auth::user()->avatar_original)}}" class="rounded-circle size-20px">
                        @else
