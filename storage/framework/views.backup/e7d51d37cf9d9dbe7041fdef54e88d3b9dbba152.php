...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><?php echo e(translate('Customer Withdraw Request')); ?></h5>
        </div>
        <div class="card-body">
                    ...
                    <?php $__currentLoopData = $seller_withdraw_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $seller_withdraw_request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($user  ): ?>
                            <tr>
                                ...
                                <td><?php echo e($user->name); ?> (<?php echo e($user->name); ?>)</td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/longkubz1/public_html/resources/views/backend/sellers/seller_withdraw_requests_all_by_user/index2.blade.php ENDPATH**/ ?>