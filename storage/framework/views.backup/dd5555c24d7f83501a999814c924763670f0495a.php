        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                <div class="form-group mb-0">
                    <input type="text" class="aiz-date-range form-control"  name="date" placeholder="<?php echo e(translate('Filter by date')); ?>" data-format="Y-MM-DD" data-separator=" to " data-advanced-range="true" autocomplete="on">
                </div>
            </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/longkubz1/public_html/resources/views/backend/sellers/index.blade.php ENDPATH**/ ?>