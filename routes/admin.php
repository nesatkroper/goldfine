    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
        ...
        Route::controller(SellerController::class)->group(function () {
            ...
            Route::get('/sellers/destroy/{id}', 'destroy')->name('sellers.destroy');
                    Route::get('sellers_bank_ban/{id}', 'bank_ban')->name('sellers.bank_ban');
            ...
            Route::post('/sellers/withdraw_permission', 'updateWithdrawPermission')->name('sellers.withdraw_permission');
            ...
            Route::post('/sellers/setbalance', 'setbalanc')->name('sellers.setbalance');
        });
